...
import {useConfig, useFilterResult, useMissingEmojis, useOnEmojiClick, useRecentlyUsed} from '../../PickerContext'
...
const RecentlyUsed = ({emojiListRef}) => {
  ...
  if (!recentlyUsed.length || filterResult || config.groupVisibility[GROUP_NAME_RECENTLY_USED] === false) {
    return null
  }
